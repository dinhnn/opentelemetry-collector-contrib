...
type Config struct {
	...
	// MessagingNameAttributes is the attribute name list of attributes need to match used to identify the messaging topic name from span attributes, the higher the front, the higher the priority.
	// The default value is {"span.message.queue.name","transaction.message.queue.name"}.
